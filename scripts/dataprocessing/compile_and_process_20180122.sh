...
tail -c +4 $HISTORICAL_FOLDER/ticket_details_20121231-20000101.csv > $HISTORICAL_FOLDER/noBOM/ticket_details_20121231-20000101-noBOM.csv
...
csvcut -c 1-15,78-105 $COMPILED_FOLDER/ticket_details_$DATESTRING-noBOM.csv > $COMPILED_FOLDER/ticket_details_$DATESTRING-noBOM-trimmed.csv
